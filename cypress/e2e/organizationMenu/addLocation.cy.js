describe('add location', () => {
    it('success add location', () => {
      ...
      cy.get(':nth-child(1) > .oxd-grid-2 > .oxd-grid-item > .oxd-input-group > :nth-child(2) > .oxd-input').type('Detailing Buddy HQ')
    ...
    it('failed add location empty name', () => {
        cy.visit('https://opensource-demo.orangehrmlive.com/')
        cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type('Admin')
        cy.get(':nth-child(3) > .oxd-input-group > :nth-child(2) > .oxd-input').type('admin123')
        cy.get('.oxd-button').click()
    ...
    it('failed add location empty country', () => {
      cy.visit('https://opensource-demo.orangehrmlive.com/')
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type('Admin')
      cy.get(':nth-child(3) > .oxd-input-group > :nth-child(2) > .oxd-input').type('admin123')
      cy.get('.oxd-button').click()
      ...
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type('west java')
      cy.get(':nth-child(3) > .oxd-input-group > :nth-child(2) > .oxd-input').type(16451)
      cy.get(':nth-child(1) > .oxd-grid-2 > .oxd-grid-item > .oxd-input-group > :nth-child(2) > .oxd-input').type('Prima imaging')
      cy.get('.oxd-button--secondary').click()
      cy.get('.oxd-input-group > .oxd-text').should('be.visible')
    })
